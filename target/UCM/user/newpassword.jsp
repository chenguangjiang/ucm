    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                <label>用户名</label>
                <input type="username" class="form-control" id="name" placeholder="Username" disabled="true" value="${user.name}" name="name" style="width: 100%;height: 40px">
            </div>
            </br>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <button  id="send" class="btn btn-primary btn-lg" onclick="aapassword()" style="width: 100%;">确定</button>
            </div>
